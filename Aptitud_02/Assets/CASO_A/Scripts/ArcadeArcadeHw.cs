...
public class ArcadeArcadeHw : Servicer, HandledBehaviour.IHandlerBehaviour
{
	...
	void InsertCoin()
	{
		...
		Invoke("EndCoin", level == 1 ? 6.5f : level == 2 ? 5.6f : 3f);

		//play sound - no hay sonido para este objeto
